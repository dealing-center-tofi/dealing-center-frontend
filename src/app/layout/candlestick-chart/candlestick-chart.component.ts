...
export class CandlesTickChart implements OnInit {
  ...
  ngOnInit(): void {
    this.chart = this.initCandlestickChart();
  }
  ...
  initCandlestickChart(): any {
    ...
    nv.addGraph(function() {
      ...
      chart.yAxis
        .axisLabel('Price')
        .tickFormat(function(d,i){ return d3.format(',.4f')(d); });

      d3.select("#candlestick-chart svg")
        .style('height', this.height || '500px')
        .datum(data)
      ...
      setTimeout(() => {
        data[0].values.push({
          "date": 15954, "open": 165.42, "high": 165.8, "low": 164.34, "close": 165.22,
          "volume": 160363400, "adjusted": 164.35
        });
        data[0].values.push({
          "date": 15954, "open": 165.42, "high": 165.8, "low": 164.34, "close": 165.22,
          "volume": 160363400, "adjusted": 164.35
        ...
        data[0].values.push({
          "date": 15957, "open": 165.42, "high": 165.8, "low": 164.34, "close": 165.22,
          "volume": 160363400, "adjusted": 164.35
        });
        data[0].values.push({
          "date": 15958, "open": 165.42, "high": 165.8, "low": 164.34, "close": 165.22,
          "volume": 160363400, "adjusted": 164.35
        });
        data[0].values.push({
          "date": 15959, "open": 165.42, "high": 165.8, "low": 164.34, "close": 165.22,
          "volume": 160363400, "adjusted": 164.35
        });
        chart.update();
      }, 3000);
